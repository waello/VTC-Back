...
import com.navettevatry.rem4u.common.resources.dto.EureCab.Vehicle;
...
public class Data implements Serializable {
    ...
    public Data(Long id, String company, String seo, String name, Boolean isCarSeat, Boolean isHybrid, Boolean isElectric, Boolean isWifi, Boolean isWoman, Boolean isCovidProtect, Boolean isDi, Boolean isAirport, Boolean isMultipleDrivers, Object ghostUntil, Long typeActivity, String voteAverage, Long voteCount, Boolean isCentral, Double priceFinal, Double rankScore, Double rankQuality, String profilePic, Date timeout, Boolean immediateAccept, Boolean favorite, Boolean hasDiscount, Double priceDiscount, Object discountCode, Vehicle vehicle, Boolean isSuperdriver, Long scoreQuality, Central central, String priceText) {
        this.id = id;
    ...
    public Object getGhostUntil() {
        return ghostUntil;
    }

    public void setGhostUntil(Object ghostUntil) {
        this.ghostUntil = ghostUntil;
    }
    ...
    public Double getRankQuality() {
        return rankQuality;
    }

    public void setRankQuality(Double rankQuality) {
        this.rankQuality = rankQuality;
    }
    ...
    public Long getScoreQuality() {
        return scoreQuality;
    }

    public void setScoreQuality(Long scoreQuality) {
        this.scoreQuality = scoreQuality;
    }
