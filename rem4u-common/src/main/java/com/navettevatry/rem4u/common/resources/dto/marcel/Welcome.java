...
public class Welcome {
    ...
    private boolean sendableToExpensya;
    ...
    @JsonProperty("co2")
    public void setCo2(double value) { this.co2 = value; }
    ...
    public boolean getSendableToExpensya() { return sendableToExpensya; }
    @JsonProperty("sendable_to_expensya")
    public void setSendableToExpensya(boolean value) { this.sendableToExpensya = value; }
    ...
    public boolean getIsFirstRide() { return isFirstRide; }
    @JsonProperty("is_first_ride")
    public void setIsFirstRide(boolean value) { this.isFirstRide = value; }
    ...
    @JsonProperty("passenger")
    public void setPassenger(Passenger value) { this.passenger = value; }

    @JsonProperty("surge_coefficient")
    public double getSurgeCoefficient() { return surgeCoefficient; }
    @JsonProperty("surge_coefficient")
    public void setSurgeCoefficient(double value) { this.surgeCoefficient = value; }
